    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function confirmarExclusao() {                
                var resultado = confirm("Tem certeza que deseja excluir esse Pensamento?");				
                return resultado;                
            }        
    ...
    <body>
        ...
        <div id="conteudo">
            ...
            <div id="box-titulo-secao">
                <div class="limite">
                    <h1 class="tituloSecao">listagem dos pensamentos</h1>
                </div>
            </div>
                    ...
                    <tbody>
                        ...
                        <?php
                            ...
                            if($con) {
                                ...
                                $pen = new Pensamento();
                                $pen->listar("SELECT * FROM pensamento ORDER BY id DESC", "administrador");
